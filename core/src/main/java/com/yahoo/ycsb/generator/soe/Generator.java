...
public abstract class Generator {
  ...
  private void tokenizeFields(JSONObject obj, HashMap<String, String> tokens) {
    ...
    ArrayList<String> stringFields = new ArrayList<>(Arrays.asList(SOE_FIELD_CUSTOMER_ID,
          ...
          SOE_FIELD_CUSTOMER_BALLANCE, SOE_FIELD_CUSTOMER_DOB, SOE_FIELD_CUSTOMER_EMAIL,
          SOE_FIELD_CUSTOMER_PHONECOUNTRY, SOE_FIELD_CUSTOMER_PHONE, SOE_FIELD_CUSTOMER_AGEGROUP,
          SOE_FIELD_CUSTOMER_URLPROTOCOL, SOE_FIELD_CUSTOMER_URLSITE, SOE_FIELD_CUSTOMER_URLDOMAIN,
          SOE_FIELD_CUSTOMER_URL));
