 ...
 *
 */
public class CustomTransactionCollWorkload extends CustomCollectionWorkload {
  ...
  public void doTransactionCustom(DB db) {
    ...
    db.transaction(table, transationKeys, transationValues, transationOperations, fields,
        result, scopename, collname);
  }
